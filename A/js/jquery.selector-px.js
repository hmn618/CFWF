;(function($){
    ...
    $('body').append('<style>'+
                ...
                '.sel-box{position:fixed;bottom:0;left:0;right:0;z-index:999;height:238px;}'+
                '.sel-box .btn{background:#CCCCCC;overflow:hidden;width:100%;}'+
                '.sel-box .btn1{overflow:hidden;width:45px;height:45px;float:left;padding:11px 12px;}'+
                '.sel-box .btn1 img{float:left;width:100%;height:100%;}'+
                '.sel-box .ok{float:right;}'+
                '.sel-box .name{width:100%;color:white;text-align:center;line-height:22px;font-size:18px;padding:11px 0;}'+
