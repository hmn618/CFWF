		...
		$.ajax({
			...
			success:function(data)
			{
				...
				{	
					...
					document.getElementById("example_video_1").setAttribute('poster',articleVideo.coverDir);
					var links=document.getElementsByClassName("link");
					document.getElementsByClassName("link").src=articleVideo.originalLink;
						document.getElementById("example_video_1").src=articleVideo.originalLink;
						//document.getElementById("example_video_1").controls.play();
